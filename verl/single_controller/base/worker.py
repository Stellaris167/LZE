...
class Worker(WorkerHelper):
    ...
    def _setup_env_cuda_visible_devices(self):
        ...
        if is_ray_noset_visible_devices:
            ...
            # Even when Ray sets CUDA_VISIBLE_DEVICES automatically, we still need to
            # explicitly set the CUDA device for PyTorch to avoid "device busy" errors
            # on some GPU architectures (e.g., NVIDIA Blackwell B200).
