...
class RolloutConfig(BaseConfig):
    ...
    repetition_detection_check_interval: int = 50
    repetition_detection_max_tokens_after_box: int = 200
    repetition_detection_detect_multiple_boxes: bool = True
    repetition_detection_detect_rethink_patterns: bool = True
    repetition_detection_max_box_length: int = 500
