...
class BaseEngine:
    ...
    def to(self, device: str, model: bool = True, optimizer: bool = True, grad: bool = True):
        ...
        """
        # Allow optimizer-only offload without model offload
        # The original assertion was too strict for hybrid offload scenarios
        if not model and grad:
            raise ValueError("Cannot move gradients without moving model parameters")
