...
class AgentData:
    ...
    def __init__(
        ...
        self.stop_reason: Optional[str] = None  # Track last generation's stop reason
...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        output = AgentLoopOutput(
            ...
            stop_reason=agent_data.stop_reason,
            extra_fields={},
        )
    ...
    async def _handle_generating_state(
        ...
        # Save stop_reason from this generation
        agent_data.stop_reason = output.stop_reason
